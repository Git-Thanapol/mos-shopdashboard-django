try:
    ...
    import views.tag_management as p_tags
    ...
    with st.sidebar:
        ...
        menu_items = {
            ...
            "TAG_MANAGEMENT": "🏷️ จัดการแท็กสินค้า",
        }
    ...
    if selected_page == "FILE_MANAGER":
        ...
        try:
            ...
            if df_daily.empty and selected_page not in ("MASTER_ITEM", "TAG_MANAGEMENT"): 
            ...
            elif selected_page == "TAG_MANAGEMENT":
                p_tags.show(df_daily, df_fix_cost, sku_map, sku_list, sku_type_map, category_options)
